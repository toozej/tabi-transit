...
| Completed / evidence-gated | WP-12 Notifications                                                                                                               | Contract, fixture-only mobile settings, encrypted-token persistence, and a disabled worker are integrated. Real permission, token registration, delivery, and receipts remain evidence-gated.            |
