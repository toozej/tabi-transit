...
| Active                   | WP-10 Rider Information                                                                                                           | Contract, static backend endpoints, deterministic mobile screens, accessibility alternatives, and runtime container foundation are integrated; arrivals/schedules/alerts remain storage-gated. |
| Pending                  | WP-11, WP-12, WP-15, WP-18                                                                                                        | Start only when their stated dependencies and approval gates are met.                                                                                                                          |
...
Continue Phase 2 normalized schedules/alerts storage and non-device operations/security work. The physical development-build demonstration (restricted public Mapbox token, Android and iOS devices, and Maestro) is explicitly waived as a local-workstation blocker by the user, but remains unverified and required before any production-release claim.
