...
| -------------- | --------------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D-001          | TriMet Web Services terms and production enablement | Production TriMet arrivals and A-to-B planning        | The documented Arrivals V2 adapter has a successful read-only local smoke test (2026-07-24) using the uninspected AppID. It remains feature-disabled pending terms, retention, attribution, beta, and planner review. | Reviewed terms covering rate limits, caching/retention, attribution, beta expectations, and planner constraints; then an explicit feature-enable decision. |
...
- **TriMet Arrivals V2 boundary correction (2026-07-23):** The adapter now
  ...
  secret file in this workspace. On 2026-07-24, the user-ran local smoke test
  reached TriMet and revealed numeric `locid`/`route` fields; the adapter now
  normalizes those opaque IDs and the subsequent read-only smoke test passed.
  No AppID or provider response body was printed.
