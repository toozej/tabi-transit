...
| -------------- | --------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D-001          | TriMet Web Services terms and production enablement | Production TriMet arrivals and A-to-B planning        | The documented Arrivals V2 adapter has a successful read-only local smoke test (2026-07-24) using the uninspected AppID. `make test-trimet-live` is the repeatable local check. It remains feature-disabled pending terms, retention, attribution, beta, and planner review. | Reviewed terms covering rate limits, caching/retention, attribution, beta expectations, and planner constraints; then an explicit feature-enable decision. |
