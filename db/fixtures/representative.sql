...
INSERT INTO transit.services (feed_version_id, service_id)
SELECT id, 'weekday' FROM catalog.feed_versions WHERE source_id = 'fixture-gtfs' AND status = 'active';
INSERT INTO transit.service_calendars (feed_version_id, service_id, monday, tuesday, wednesday, thursday, friday, saturday, sunday, start_date, end_date)
...
INSERT INTO transit.service_calendar_dates (feed_version_id, service_id, service_date, exception_type)
SELECT id, 'weekday', '2026-07-04', 2 FROM catalog.feed_versions WHERE source_id = 'fixture-gtfs' AND status = 'active';
...
SELECT id, 'fixture:trip:20-1', 'fixture:stop:bus-nearest', 1, 90930, 90930
FROM catalog.feed_versions WHERE source_id = 'fixture-gtfs' AND status = 'active';
