...
export interface components {
    schemas: {
        ...
        Coordinate: number[];
        /** @enum {string} */
        TransitMode: "bus" | "light_rail" | "streetcar" | "commuter_rail" | "ferry" | "unknown";
        /** @enum {string} */
        ...
        /** @enum {string} */
        ErrorCode: "validation_error" | "not_found" | "conflict" | "rate_limited" | "source_unavailable" | "temporarily_unavailable" | "internal_error";
        ErrorDetail: {
            field: string;
            code: string;
            message?: string;
    ...
    listVehicles: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["VehicleCollection"] | components["schemas"]["VehicleFeatureCollection"];
                };
            };
            304: components["responses"]["NotModified"];
            400: components["responses"]["ValidationError"];
